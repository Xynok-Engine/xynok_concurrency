//! src: https://github.com/crossbeam-rs/crossbeam/blob/main/crossbeam-utils/src/cache_padded.rs
use core::fmt;
...
#[cfg_attr(any(target_arch = "x86_64", target_arch = "aarch64", target_arch = "arm64ec", target_arch = "powerpc64",), repr(align(128)))]
