...
#[test]
fn scope_cho_moi_job_no_spawn_ra()
{
...
#[test]
fn job_muon_duoc_stack_cua_nguoi_mo_scope()
{
...
#[test]
fn scope_long_nhau_khong_deadlock()
{
...
#[test]
fn scope_long_nhau_ba_tang_tren_mot_worker()
{
...
#[test]
fn panic_trong_job_duoc_nem_lai_o_diem_join()
{
...
#[test]
fn panic_cua_than_scope_van_cho_job_chay_xong()
{
    let pool = pool_with(2);
    let done = Arc::new(AtomicUsize::new(0));
...
#[test]
fn join_long_nhau_thanh_cay_de_quy()
{
...
#[test]
fn parallel_for_cham_moi_chi_so_dung_mot_lan()
{
    let n = scaled(10_000);
...
#[test]
fn batch_lon_hon_n_thi_chay_tuan_tu_ngay_tai_cho()
{
    let pool = pool_with(4);
...
#[test]
fn parallel_for_tren_pool_khong_worker_van_chay_du()
{
...
#[test]
fn par_reduce_cong_dung_tong()
{
    let pool = pool_with(4);
    let n = scaled(10_000);
    let total = pool.par_reduce(n, 64, || 0u64, |acc, i| acc + i as u64, |a, b| a + b);
    assert_eq!(total, (0..n as u64).sum::<u64>());
}

#[test]
fn par_reduce_noi_theo_thu_tu_lo_nen_ket_qua_lap_lai_duoc()
{
    let pool = pool_with(4);

    // Phép nối không giao hoán: kết quả chỉ giữ nguyên nếu thứ tự nối là cố định.
    let n = scaled(1_000);
    let first = pool.par_reduce(
        n,
        16,
        String::new,
        |mut acc, i| {
...
#[test]
fn scope_tra_ve_gia_tri_cua_than_no()
{
    let pool = pool_with(2);
...
#[test]
fn job_trong_scope_spawn_tiep_vao_chinh_scope_do()
{
...
#[test]
fn scope_tren_pool_dung_chung_giua_nhieu_thread()
{
...
#[test]
fn tha_pool_ngay_sau_scope_long_nhau_khong_lam_worker_join_chinh_no()
{
